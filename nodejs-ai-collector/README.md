...
- ✅ CLI интерфейс для работы через командную строку
- ✅ REST API для интеграции с другими системами
- ✅ Поддержка параллельного опроса моделей
- ✅ Статистика и анализ собранных данных в реальном времени
...
- 📝 Форму для ввода промптов с примерами
- ☑️ Выбор моделей для опроса
- 📊 Таблицу с результатами в реальном времени
- 📈 Статистику по собранным данным
- 🔍 Фильтры и детальный просмотр ответов
...
**Подробная документация:** См. [WEB_INTERFACE.md](WEB_INTERFACE.md)
