-- SGEO Analytics Database Schema for MySQL/MariaDB

SET FOREIGN_KEY_CHECKS=0;

-- Drop existing tables
DROP TABLE IF EXISTS llm_responses;
DROP TABLE IF EXISTS source_analytics;
DROP TABLE IF EXISTS sources;
DROP TABLE IF EXISTS prompts;
DROP TABLE IF EXISTS topics;
DROP TABLE IF EXISTS llm_systems;
...
CREATE TABLE topics (
    ...
    name_en VARCHAR(255),
    description TEXT,
    strategic_importance INT CHECK (strategic_importance BETWEEN 0 AND 10),
...
CREATE TABLE llm_responses (
    ...
    FOREIGN KEY (monitoring_run_id) REFERENCES monitoring_runs(id) ON DELETE CASCADE,
    FOREIGN KEY (topic_id) REFERENCES topics(id) ON DELETE CASCADE,
    FOREIGN KEY (llm_system_id) REFERENCES llm_systems(id) ON DELETE CASCADE,
    FOREIGN KEY (prompt_id) REFERENCES prompts(id) ON DELETE SET NULL,
    UNIQUE KEY unique_response (monitoring_run_id, topic_id, llm_system_id, prompt_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE sources (
    ...
    last_cited_at TIMESTAMP NULL DEFAULT NULL,
